import { Upload, MoreVertical, Clock, User } from 'lucide-react';


export const ElementPhotos=()=>{
	return(
		<>
	      ...
	      <div className="flex justify-between items-center">
	        ...
	        <button className="px-5 py-2 bg-white border border-slate-200 rounded-lg flex items-center gap-2 hover:bg-slate-50">
