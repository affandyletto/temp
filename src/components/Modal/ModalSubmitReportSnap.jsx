  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} sizeModal={`w-[640px]`}>
      <div>
        ...
        >
          <Input id={"label"} label={"New Report Title"} placeholder="Input report title" />
          ...
          <div className="flex justify-end space-x-2">
            <ButtonSecondary
              ...
              onClick={onClose}
            />
            <ButtonPrimary type={"submit"} label={"Create Report"} />
          </div>
        </form>
      </div>
    </Modal>
...
export default ModalSubmitReportSnap;
